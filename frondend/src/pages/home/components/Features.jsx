  ...
  return (
    <>
      <div className="flex flex-col bg-gradient-to-t from-black to-[#141414] min-h-[450px] md:bg-features-one md:h-[90dvh] w-screen z-40 bg-no-repeat bg-cover overflow-hidden justify-center ">
        ...
        <div className="flex flex-col gap-16  px-10 lg:px-24 md:px-16">
          <div className="relative bottom-20">
            ...
            <ul className="text-secondary-text text-base  flex flex-col gap-6 child:flex child:items-start child:gap-1 my-8">
              <li>
                <AiOutlineCheck className="text-2xl flex-shrink-0"></AiOutlineCheck>{" "}
      ...
      <div
        ...
        className="flex flex-col bg-gradient-to-br from-black to-[#141414] min-h-[450px] md:bg-features-one md:h-[90dvh] w-screen z-40 bg-no-repeat bg-cover overflow-hidden justify-center "
      >
        ...
        <div className="flex flex-col gap-16  px-10 lg:px-24 md:px-16">
          <div className="relative bottom-20">
            ...
            <ul className="text-secondary-text text-base  flex flex-col gap-6 child:flex child:items-start child:gap-1 mt-8">
              <li>
                <AiOutlineCheck className="text-2xl flex-shrink-0"></AiOutlineCheck>
