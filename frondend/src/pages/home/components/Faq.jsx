...
export function Faq() {
  return (
    <div className="flex flex-col bg-gradient-to-bl from-black to-[#141414] min-h-[450px] py-10 px-2 relative">
      <h1 className="text-2xl font-bold text-white text-center mb-4">FAQ</h1>
      <ul className="text-secondary-text child:m-5 child:border-b child:border-[#4d4d4d] child:p-2 child:flex child:gap-3 child:items-center relative child:relative">
        <li>
