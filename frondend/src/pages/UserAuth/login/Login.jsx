...
export function Login() {
  ...
  return (
    <div className="w-full h-[100dvh] min-h-[700px] flex justify-center items-center relative bg-no-repeat bg-center bg-cover background-overlay bg-opacity-20">
      <div className="sm:w-[480px] w-full sm:h-[550px] h-full bg-black text-white items-center px-10 pt-20 rounded-xl flex flex-col gap-4 child:w-full">
        {/* Header */}
        <div className="flex flex-col gap-1 pb-4">
          <h1 className="font-bold text-2xl">Log in</h1>
          <h2 className="text-sm text-gray-300">Continue to Ferrisport</h2>
        </div>
        {/* Inputs */}
